If you have the generated MAT files Results_without_cov_estimation.mat and Results_with_cov_estimation.mat, 
for result plotting simply run Analyze_results.m. If you do not have the kernel result mat files the program will stop prematurely.
